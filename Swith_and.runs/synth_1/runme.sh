...
HD_PWD='D:/research/Vivado/Swith_and/Swith_and.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sMDT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sMDT.tcl
