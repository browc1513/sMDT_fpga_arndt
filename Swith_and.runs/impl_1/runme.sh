...
HD_PWD='D:/research/Vivado/Swith_and/Swith_and.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sMDT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sMDT.tcl -notrace
