...
HD_PWD='C:/Users/smdt/XADC_DUAL/XADC_DUAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myADC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myADC.tcl -notrace
