...
HD_PWD='C:/Users/sMDT/Documents/GitHub/sMDT_fpga_arndt/uart_test/uart_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_TX_CTRL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_TX_CTRL.tcl -notrace
