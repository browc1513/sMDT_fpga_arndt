...
HD_PWD='C:/Users/sMDT/Documents/GitHub/sMDT_fpga_arndt/uart_test/uart_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_TX_CTRL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_TX_CTRL.tcl
